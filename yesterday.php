...
<?php include("public/title.php");?>
    ...
    <div class="war" style="padding-top:10px; overflow:hidden;">
        ...
        <div class="right">
				...
				$time = time();
				$tim=date("Y-m-d",strtotime("-1 day"));
                $Page_size=10; 
                $wfstatus=$_GET['wfstatus'];
				
				$sql_count = "select * from wforderlist where  date(wfdate)='$tim' and wfproduct like '%$product%'"; 
				if($wfstatus!=""){
						$sql_count= $sql_count." and wfstatus='$wfstatus' and wfproduct like '%$product%'";
				}
				...
				$sql="select * from wforderlist  where  date(wfdate)='$tim' and wfproduct like '%$product%' "; 
				if($wfstatus!=""){
                ...
                //$sql="select * from wforderlist  where  date(wfdate)='$tim'  ORDER BY id desc limit $offset,$Page_size"; 
