...
<body bgcolor="#626262">
    ...
    <div class="war" style="padding-top:10px; overflow:hidden;">
        ...
        <div class="right">
                ...
                <div class="clear"></div>
         		 <?php include("public/qs_select.php");?>
                <div class="clear"></div>
				<style>
				...
				$sql_count = "select * from wforderlist where  xszt='签收' and wfproduct like '%$product%'"; 
                ...
                $sql="select * from wforderlist  where  xszt='签收' and wfproduct like '%$product%'"; 
