    ...
    <div class="war" style="padding-top:10px; overflow:hidden;">
        ...
        <div class="right">
				...
				$end_date = $_GET['end_date'];
				 ...
				 if($url!=""){
                    $sql = "select id,openid,time,name,phone,address from brand_shu_weixin_choujiang where (time between '$start_date' and '$end_date') and (id like '$url' or name like '$url' or phone like '$url') ORDER BY id desc";
                } else {
					$sql = "select id,openid,time,name,phone,address from brand_shu_weixin_choujiang where time between '$start_date' and '$end_date' ORDER BY id desc";
				}
				//var_dump($sql);
                ...
                //$sql ="select id,openid,time,name,phone,address from  brand_shu_weixin_choujiang where time between '$start_date' and '$end_date' ORDER BY id desc limit $offset,$Page_size";
				//var_dump($sql);
				//exit;
                $result=mysql_query($sql); 
                    ...
                    <td colspan="14" bgcolor="#E0EEE0">
                        ...
                        <?php
                               $he=mysql_query("select sum(wfprice) as 'count' from wforderlist ");
                                ...
                                echo "订单总数:<font style='color:red; font-weight:bold;'>".$count."</font>";
                               // echo "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;";
