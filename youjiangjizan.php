...
<body bgcolor="#626262">
    ...
    <div class="war" style="padding-top:10px; overflow:hidden;">
        ...
        <div class="right">
                ...
                <div class="clear"></div>
				 <?php include("public/select1.php");?>
                <div class="clear"></div>
                ...
                <!--表格头结束-->
                <?php
			     $conn=mysql_connect("127.0.0.1","root","g7rg6431d67gt814f@#145") or die("数据库连接失败".mysql_error());
                 mysql_select_db("youjiangjizan",$conn) or die("找不到数据库".mysql_error());
...
//				echo $count;
                ...
                $sql="select * from user_info ORDER BY id desc limit $offset,$Page_size";
                    ...
                    <td colspan="14" bgcolor="#E0EEE0">
                        ...
                        <?php
                               $he=mysql_query("select sum(wfprice) as 'count' from wforderlist ");
                                ...
                                echo "<font style='color:red; font-weight:bold;'>".$count."</font>";
                               // echo "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;";
