    ...
    <div class="war" style="padding-top:10px; overflow:hidden;">
     <?php include("public/left.php");?>
        ...
        <div class="right">
                ...
                $Page_size=10; 
                $result=mysql_query("select * from wforderlist where wfstatus='待淘' and wfproduct like '%$product%';"); 
                ...
                $sql="select * from wforderlist where wfstatus='待淘' and wfproduct like '%$product%' ORDER BY id desc limit $offset,$Page_size"; 
                ...
                <td colspan="14" bgcolor="#E0EEE0">
                	...
                	<?php
							$he=mysql_query("select sum(wfprice) as 'count' from wforderlist where wfstatus='待淘' and wfproduct like '%$product%';");
