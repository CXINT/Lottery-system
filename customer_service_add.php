...
<?php include("public/title.php");?>
    ...
    <div class="war" style="padding-top:10px; overflow:hidden;">
        ...
        <div class="right">
                ...
                $result=mysql_query("select * from wforderlist where WFDDURL is null"); 
                ...
                $sql="select * from wforderlist where WFDDURL is null ORDER BY id desc limit $offset,$Page_size"; 
                ...
                <td colspan="14" bgcolor="#E0EEE0">
                	...
                	<?php
							$he=mysql_query("select sum(wfprice) as 'count' from wforderlist where  WFDDURL is null and wfproduct like '%$product%';");
