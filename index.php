...
<body bgcolor="#626262">
    ...
    <div class="war" style="padding-top:10px; overflow:hidden;">
        ...
        <div class="right">
                ...
                $Page_size=10; 
                $result=mysql_query("select * from brand_shu_weixin_choujiang");
				//var_dump($result);
...
//				echo $count;
                ...
                $sql="select * from brand_shu_weixin_choujiang  ORDER BY id desc limit $offset,$Page_size";
				//var_dump($sql);
				//exit;
