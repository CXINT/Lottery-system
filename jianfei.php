    ...
    <div class="war" style="padding-top:10px; overflow:hidden;">
        ...
        <div class="right">
                ...
                <tr style="background:#EAEAEA;">
                    <th width="30" height="41">编号</th>
                    <th width="40" height="41">姓名</th>
                    <th width="67" height="41">电话</th>
                    <th width="50" height="41">时间</th>
                    <th width="60">IP</th>
                    <th width="60">方便接听</th>
                    <th width="110">网站</th>
                    <th width="60">产品名称</th>
                ...
                <!--表格头结束-->
                <?php 
				 $conn=mysql_connect("127.0.0.1","root","88*ns2016$88") or die("数据库服务器连接错误".mysql_error());//88*ns2016$88
				 mysql_select_db("jianfei",$conn) or die("数据库访问错误".mysql_error());
				 mysql_query("set character set utf8");
				 mysql_query("set names utf8");
                $Page_size=18; 
                $result=mysql_query("select * from wforderlist");	
...
//				echo $count;
                ...
                $sql="select * from wforderlist  ORDER BY id desc limit $offset,$Page_size"; 
...
<tr> 			
                ...
                <td><?php echo $row['wfmob']; ?></td>
                <td><?php echo $row['wfdate']; ?></td>
                <td><?php echo $row['wfipadd']; ?></td>
                <td><?php echo $row['wfproductb']; ?></td>
                <td><?php echo $row['WFDDURL']; ?></td>
                 <td><?php echo $row['wfproduct']; ?></td>
                  <td><?php echo $row['wfaddress']; ?></td>
</tr> 
                	<!--表格身体结束-->
