...
<div class="sle" style="position:relative;">
    <form action="query.php" method="GET">
        <div style=" padding:7px 0px 7px 10px;">
            日&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;期：	
			<!--<input type="text" class="mh_date"  name="select" placeholder="开始时间" id="start_date" />-->			
            <!--<input type="text" name="select"   id="start_date" />-->
			...
			<!--<input type="text" name="select1" placeholder="结束时间" id="end_date" />-->
			<!--<input type="text" class="mh_date"  name="select1" placeholder="结束时间" id="end_date" />-->
	...
	<div style="position:absolute; width:25px; height:25px; background:url(img/8.gif) no-repeat; left:905px; top:-15px;"></div></a>
<a href="log.php">    <div style="position:absolute; font-size:7px;  left:955px; top:-15px;">LOG</div></a>
</div>
<div class="clear"></div>